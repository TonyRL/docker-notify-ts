...
This guide will show you how to run the [docker-notify](https://github.com/TonyRL/docker-notify-ts) docker image on a Synology NAS running DSM 6.
...
Open the Docker app on your Synology DSM, go to the `Registry` section and then search for and download the [chlabbi/docker-notify](https://github.com/TonyRL/docker-notify-ts) image.

![Download chlabbi/docker-notify docker image](.github/images/4Registry.png)

## 5. Create Container.

When the container download is complete, launch a new container using the [chlabbi/docker-notify](https://github.com/TonyRL/docker-notify-ts) image.

## 6. Name your container.

Choose a name and then click `Advanced Settings`:

![Name your container](.github/images/6Create0.png)
...
![General settings](.github/images/7Create1.png)

## 8. Configure the Volume tab.

Click the `Volume` tab and then **Add Folder**.

![Configure Volume info 1](.github/images/8aVolumes.png)
...
![Environment variables](.github/images/10Enviornment.png)

Click `OK` to save your advanced settings and then click `Apply` to start the [Schlabbi/docker-notify](https://github.com/TonyRL/docker-notify-ts) container.

![Network settings](.github/images/11Running.png)
...
![Environment variables](.github/images/12Log.png)
...
1. Go to the `Registry` tab and find `schlabbi/docker-notify` by searching for `docker-notify`. Select it and use the `Download` button or double click on it.
   ![Download the that Image](.github/images/download.png)
